package com.canerkpsz.bilgisaklamaprojesi
...
import com.canerkpsz.bilgisaklamaprojesi.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sharedPreferences = this.getSharedPreferences("com.canerkpsz.bilgisaklamaprojesi",
